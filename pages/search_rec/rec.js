...
Page({
  data: {
    ...
    user_info:[
      ...
      tags: ['Off-Campus','Female','Consul']},
      {name: "Lina Guo, 2024", img: '/image/profilepics/pic3.jpeg',
      tags: ['Off-Campus','Consul','Neat']},
      {name:'Mingyue Feng, 2022', img:'/image/profilepics/profile_pic.png', tags:['Off-Campus', 'Consul','Early Bird']},
      {name:'Yiran Wei, 2023', img:'/image/profilepics/profile_pic.png', tags:['Off-Campus', 'Consul','Non-Drinker']}
    ],
    invitations:[
